...
Robot.prototype.onStep = function() {
  ...
  for(var i in robots) {
    ...
    if(this.root.position.distanceTo(r.root.position) < 40) {
      this.root.rotateY(Math.PI);
      this.root.translateZ(15);
    }
  }
...
Robot.prototype.onAnimate = function() {
  ...
  if (this.movement == 'raise left arm') {
    ...
    if (this.left_upperleg.quaternion.w < 0.93) {
      ...
      this.right_upperleg.quaternion.slerp( new THREE.Quaternion(0,0,0,1), 0.25 );
    ...
    if (this.right_upperleg.quaternion.w < 0.93) {
      ...
      this.left_upperleg.quaternion.slerp( new THREE.Quaternion(0,0,0,1), 0.25 );
